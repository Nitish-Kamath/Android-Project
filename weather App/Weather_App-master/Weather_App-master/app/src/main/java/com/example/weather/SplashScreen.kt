...
class SplashScreen : AppCompatActivity() {
     // FusedLocationProviderClient is an google api which helps in getting current weather
...
// this method will return the latitude and longitude to main activity through intent
        getLastLocation()
    }
